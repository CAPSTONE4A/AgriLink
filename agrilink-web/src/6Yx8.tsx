    ...
    <section className="space-y-6">
      ...
      {isLoading ? (
        ...
        <>
          ...
          <Card title="Profile Details" description="Update your avatar, gender, and birthday.">
              ...
              <div className="grid gap-4 sm:grid-cols-2">
                <div className="sm:col-span-2">
                  ...
                  <div className="mt-3 flex items-center gap-4">
                    <Avatar name={user?.name ?? 'Farmer'} imageUrl={avatarUrl || undefined} className="h-14 w-14" />
