...
const ProfilePage = () => {
  ...
  const saveField = (values: { avatarUrl?: string; gender?: Gender | ''; birthday?: string }) => {
  ...
  const [editMode, setEditMode] = useState<{ avatar: boolean; gender: boolean; birthday: boolean }>({
    avatar: false,
    gender: false,
    birthday: false,
  });
