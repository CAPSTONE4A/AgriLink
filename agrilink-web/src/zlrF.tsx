      ...
      <Card className="max-w-2xl w-full space-y-6">
        ...
        <div className="rounded-2xl border border-slate-200 bg-white p-1">
          <div className="relative flex">
            {/* selection indicator */}
            <div
              className="absolute top-1 left-1 h-[calc(100%-0.5rem)] w-[calc(50%-0.5rem)] rounded-2xl bg-gradient-to-r from-green-800/20 via-indigo-800/10 to-indigo-900/20 shadow-[0_10px_20px_rgba(15,23,42,0.18)] transition-all duration-900 ease-in-out"
              style={{
