      ...
      <div className="mx-auto max-w-7xl">
        <section className="rounded-[2rem] bg-white p-8 shadow-xl shadow-slate-200/80">
          <div className="flex flex-col gap-6 lg:flex-row lg:items-center lg:justify-between">
            <div>
              ...
              <h1 className="mt-4 text-4xl font-semibold text-slate-950">Manage crops, orders, and harvest listings.</h1>
              <p className="mt-4 max-w-2xl text-slate-600">Track farm activity, publish your harvest, and connect directly with buyers.</p>
            </div>
        ...
        <section className="mt-10 rounded-[2rem] bg-white p-8 shadow-xl shadow-slate-200/60">
          ...
          <div className="mt-8 grid gap-6 md:grid-cols-3">
            {[
              { title: 'Publish harvest', description: 'List available crops and update quantities and pricing.' },
              { title: 'Manage orders', description: 'Track buyer requests and confirm pickup or delivery details.' },
              { title: 'Farm reports', description: 'Review crop health, weather forecasts, and sales summaries.' },
            ].map((card) => (
